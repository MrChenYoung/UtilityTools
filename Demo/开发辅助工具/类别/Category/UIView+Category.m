...
#pragma mark - view 3d旋转
/**
 * view 3d旋转
 * xAngle x方向上的旋转角度(弧度)
 * yAngle y方向上的旋转角度(弧度)
 * subTransform 是否在让所有子试图旋转(YES旋转子试图,NO旋转当前视图)
 */
- (void)viewTransform3DRotateXAngle:(CGFloat)xAngle yAngle:(CGFloat)yAngle subTransform:(BOOL)subTransform
{
    CATransform3D transform = CATransform3DIdentity;
//    transform.m34 = -1/500; // 放大3d效果
    transform = CATransform3DRotate(transform, xAngle, 0.0, 1.0, 0.0);
    transform = CATransform3DRotate(transform, yAngle, 1.0, 0.0, 0.0);
